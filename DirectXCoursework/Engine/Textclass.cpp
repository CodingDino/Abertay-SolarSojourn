...
// |						       Render										|
// |----------------------------------------------------------------------------|
bool TextClass::Render(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, 
...
// |						    UpdateSentence									|
// |----------------------------------------------------------------------------|
bool TextClass::UpdateSentence(SentenceType* sentence, char* text, int positionX, 
...
bool TextClass::RenderSentence(ID3D11DeviceContext* deviceContext, 
	SentenceType* sentence, D3DXMATRIX worldMatrix, D3DXMATRIX orthoMatrix)
{
